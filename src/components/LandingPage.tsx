    ...
    <div style={{ backgroundColor: 'var(--bg-color)', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <header id="hero" style={{ padding: '80px 0 120px 0', overflow: 'hidden' }}>
        <div className="container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
          ...
          >
            <Suspense fallback={<div style={{ padding: '60px', textAlign: 'center' }}><Loader2 className="animate-spin" size={28} /></div>}>
              <DashboardPreview />
            </Suspense>
          </motion.div>
        </div>
      ...
      <section id="analytics" className="section-padding">
        <div className="container">
          ...
          <motion.div {...fadeInUp}>
            <Suspense fallback={<div style={{ padding: '40px', textAlign: 'center' }}><Loader2 className="animate-spin" size={28} /></div>}>
              <AnalyticsShowcase />
            </Suspense>
          </motion.div>
        </div>
